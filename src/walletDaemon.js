...
module.exports = class walletNode extends EventEmitter {
  constructor (nodeAddress, readyCallback) {
    ...
    const packageDefinition = protoLoader.loadSync(__dirname + '/../protos/caswalletd.proto', {
      keepCase: true,
      longs: String,
      enums: String,
      defaults: true,
      oneofs: true
		...
		const { caswalletd } = gRPC.loadPackageDefinition(packageDefinition).caswalletd

    this._client = new caswalletd(nodeAddress, gRPC.credentials.createInsecure(), {  
